$("#add_form").submit(function (e) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            markup=`<tr>
                    <td>`+document.getElementById("accomodation_code").value+`</td>
                    <td>`+document.getElementById("accomodation_name").value+`</td>
                    <td>`+document.getElementById("multiplier").value+`</td>
                    <td>`+document.getElementById("refund_percentage").value+`</td>
                    <td>`+document.getElementById("no_refund_time").value+`</td>
                    <td>`+document.getElementById("min_refund_time").value+`</td>
                    <td>`+document.getElementById("addition_deduction_percentage").value+`</td>
                    <td>`+document.getElementById("addition_deduction_rate").value+`</td>
                    <td>Just Now</td>
                    <td>-</td>
                </tr>    `
